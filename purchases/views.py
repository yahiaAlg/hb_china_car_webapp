...
def purchase_list(request):
    ...
    purchases = Purchase.objects.select_related(
        ...
        Prefetch(
            "vehicle_set", queryset=Vehicle.objects.select_related("vehicle_purchase")
        )
    )
...
def purchase_edit(request, pk):
    ...
    return render(
        request,
        "purchases/form.html",
        {"form": form, "purchase": purchase, "title": f"Modifier Achat — {purchase}"},
    )
...
def purchase_delete(request, pk):
    ...
    return render(
        request,
        "purchases/confirm_delete.html",
        {"purchase": purchase, "title": f"Supprimer Achat — {purchase}"},
    )
...
def purchase_create(request):
    ...
    return render(
        request,
        "purchases/form.html",
        {"form": form, "title": "Nouvel Achat de Véhicule"},
    )
