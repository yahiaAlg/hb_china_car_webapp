...
class SaleForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "vehicle": forms.Select(attrs={"class": "field-input"}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            "assigned_trader",
            HTML(
                '<div id="margin-calculation" class="alert alert-info" style="display:none;"></div>'
            ),
            "notes",
            Row(
                Column(
                    Submit(
                        "submit", "Enregistrer la Vente", css_class="btn btn-primary"
                    ),
